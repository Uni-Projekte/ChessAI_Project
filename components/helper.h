...
#define ADD_MOVE(MOVES, ATTACKEDFIELDSWHITE, ATTACKEDFIELDSBLACK, X_FROM, Y_FROM, X_TO, Y_TO, FLAGS)\
    MOVES[MOVES[0]] = (CREATE_MOVE(X_FROM, Y_FROM, X_TO, Y_TO, FLAGS)); \
    MOVES[0] = MOVES[0] + 1;

#define TRY_ADD_MOVE(MOVES, ATTACKEDFIELDSWHITE, ATTACKEDFIELDSBLACK, ALL_PIECES, CURRENT_COLOR, X_FROM, Y_FROM, X_TO, Y_TO)        \
    TRY_ADD_MOVE_NO_CAPTURE(MOVES, ATTACKEDFIELDSWHITE, ATTACKEDFIELDSBLACK, ALL_PIECES, CURRENT_COLOR, X_FROM, Y_FROM, X_TO, Y_TO) \
    TRY_ADD_MOVE_ONLY_CAPTURE(MOVES, ATTACKEDFIELDSWHITE, ATTACKEDFIELDSBLACK,ALL_PIECES, CURRENT_COLOR, X_FROM, Y_FROM, X_TO, Y_TO)

#define TRY_ADD_MOVE_NO_CAPTURE(MOVES, ATTACKEDFIELDSWHITE, ATTACKEDFIELDSBLACK, ALL_PIECES, CURRENT_COLOR, X_FROM, Y_FROM, X_TO, Y_TO) \
    IF_IN_BOUNDS(                                                                             \
        X_TO, Y_TO,                                                                           \
        if (SINGLE_BIT_BOARD(X_TO, Y_TO) & ~ALL_PIECES){                                      \
            ADD_MOVE(MOVES, ATTACKEDFIELDSWHITE, ATTACKEDFIELDSBLACK, X_FROM, Y_FROM, X_TO, Y_TO, 0)})

#define TRY_ADD_MOVE_ONLY_CAPTURE(MOVES, ATTACKEDFIELDSWHITE, ATTACKEDFIELDSBLACK, ALL_PIECES, CURRENT_COLOR, X_FROM, Y_FROM, X_TO, Y_TO) \
    IF_IN_BOUNDS(                                                                               \
        X_TO, Y_TO,                                                                             \
        if (SINGLE_BIT_BOARD(X_TO, Y_TO) & ~CURRENT_COLOR & ALL_PIECES){                        \
            ADD_MOVE(MOVES, ATTACKEDFIELDSWHITE, ATTACKEDFIELDSBLACK, X_FROM, Y_FROM, X_TO, Y_TO, CAPTURE)})

#define TRY_ADD_MOVE_UPGRADE(MOVES, ATTACKEDFIELDSWHITE, ATTACKEDFIELDSBLACK, ALL_PIECES, CURRENT_COLOR, X_FROM, Y_FROM, X_TO, Y_TO) \
    IF_IN_BOUNDS(                                                                          \
        X_TO, Y_TO,                                                                        \
        if (SINGLE_BIT_BOARD(X_TO, Y_TO) & ~CURRENT_COLOR) { \
            if (Y_TO % 7 < 2) \
        { \
            ADD_MOVE(MOVES, ATTACKEDFIELDSWHITE, ATTACKEDFIELDSBLACK, X_FROM, Y_FROM, X_TO, Y_TO, CAPTURE | UPGRADE_ROOK); \
            ADD_MOVE(MOVES, ATTACKEDFIELDSWHITE, ATTACKEDFIELDSBLACK, X_FROM, Y_FROM, X_TO, Y_TO, CAPTURE | UPGRADE_KNIGHT); \
            ADD_MOVE(MOVES, ATTACKEDFIELDSWHITE, ATTACKEDFIELDSBLACK, X_FROM, Y_FROM, X_TO, Y_TO, CAPTURE | UPGRADE_BISHOP); \
            ADD_MOVE(MOVES, ATTACKEDFIELDSWHITE, ATTACKEDFIELDSBLACK, X_FROM, Y_FROM, X_TO, Y_TO, CAPTURE | UPGRADE_QUEEN); \
        } \
        else \
        { \
            ADD_MOVE(MOVES, ATTACKEDFIELDSWHITE, ATTACKEDFIELDSBLACK, X_FROM, Y_FROM, X_TO, Y_TO, CAPTURE); \
...
#define GET_PAWN_POS_FROM_BOARD(BOARD) \
    for ()
